	...
	<div class="row">
		...
		{{ Form::model($item, ['method' => 'put', 'route' => ['admin.'.$params['route'].'.update', $item->id], 'files' => true,'class' => 'form-horizontal']) }}
			...
			<div class="col-lg-8">
				<div class="box">
					<div class="box-title">
						{{ $item->title }} [<a href="http://fontawesome.io/icons/" target="_blank">список доступных иконок FontAwesome 4.7 <i class="fa fa-external-link"></i></a>  ]
					</div>
					<div class="box-body">
						...
						<div class="form-group ">
							...
							<div class="col-lg-4">
								{{ Form::label('', 'Иконка', ['class' => 'control-label']) }}
								<input type="text" class="form-control" name="jdata[widget][fields][blocks][{{$i}}][icon]" placeholder="Иконка" value="{{ $item->jd("widget.fields.blocks.{$i}.icon") }}">
							</div>
