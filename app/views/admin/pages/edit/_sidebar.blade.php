    ...
    <div class="box-body" style="padding: 20px 45px">
        ...
        <div class="form-group margin-bottom-md">
            ...
            <div class="input-group">
                @if( $edit_type == 'edit' and $item->self_url == 'index')
        ...
        <div class="form-group checkbox check-success margin-bottom-md">
            {{ Form::label('menu_item', 'Меню') }}

            @foreach($params['menus'] as $menu_id => $menu_item)

                {{ HTML::form_checkbox('menu_item[]', 'menu_item'.$menu_id, '<span></span>'.$menu_item['name'] , $menu_id, $menu_item['checked'], $errors ) }}
