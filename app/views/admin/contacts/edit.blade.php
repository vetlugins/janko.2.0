...
@section('content')
  <div class="row">
	@if ( $params['edit_type'] == 'create' )
	{{ Form::model($item, ['method' => 'post', 'route' => [ $cur_lang_route.'admin.'.$params['route'].'.store']]) }}
	@else
    {{ Form::model($item, ['method' => 'put', 'route' => [ $cur_lang_route.'admin.'.$params['route'].'.update', $item->id]]) }}
	@endif
